...
public class PanelScheduleList extends JPanel {
	...
	/**
	 * Create the panel containing all the schedules, as well as the button for
	 * individual schedules and settings
	 */
	public PanelScheduleList(Bizrain br) {
		...
		btnSettings.setIcon(
				new ImageIcon(PanelScheduleList.class.getResource("/uk/ac/cam/bizrain/ui/ico/fa-cogs-16.png")));
	...
	/*
	 * Redraws a schedule if it changes
	 */
