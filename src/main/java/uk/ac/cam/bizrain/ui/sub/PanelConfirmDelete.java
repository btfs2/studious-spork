...
public class PanelConfirmDelete extends JPanel {
	...
	/**
	 * Create the pop up panel to show for user to confirrm deletion
	 */
	public PanelConfirmDelete(String thingDeleted, ConfirmDeleteReturn cdr) {
		...
		btnBack.setIcon(new ImageIcon(
				PanelConfirmDelete.class.getResource("/uk/ac/cam/bizrain/ui/ico/fa-chevron-left-16.png")));
		...
		btnConfirm.setIcon(
				new ImageIcon(PanelConfirmDelete.class.getResource("/uk/ac/cam/bizrain/ui/ico/fa-trash-16.png")));
